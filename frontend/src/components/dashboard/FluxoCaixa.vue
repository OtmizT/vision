...
.fc-btn, .fc-input, .fc-select {
  ...
  padding: 5px 10px; font-family: var(--font-body); font-size: var(--fs-xs); outline: none;
}
...
.cal-semana {
  margin-bottom: 6px; font-family: var(--font-body); font-size: var(--fs-xs);
...
.cal-num { font-family: var(--font-body); font-size: var(--fs-sm); font-weight: 600; color: var(--text-muted); line-height: 1.3; }
.cal-val {
  font-family: var(--font-body); font-size: var(--fs-xs); line-height: 1.2;
...
.fc-table th {
  font-family: var(--font-body); font-size: var(--fs-xs); letter-spacing: 1px; color: var(--text-dim);
...
.mono { font-family: var(--font-body); font-size: var(--fs-xs); }
