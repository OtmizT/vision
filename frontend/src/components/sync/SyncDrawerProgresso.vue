...
.job-title { font-family: var(--font-body); font-size: var(--fs-sm); font-weight: 700; color: var(--text); }
...
.error-title { font-family: var(--font-body); font-size: var(--fs-xs); font-weight: 700; color: var(--danger); margin-bottom: 4px; }
...
.executor-name { font-family: var(--font-body); font-size: var(--fs-xs); font-weight: 600; color: var(--primary); }
...
.td-mono { font-family: var(--font-body); }
...
.pill-small { font-family: var(--font-body); font-size: var(--fs-xs); text-transform: uppercase; font-weight: 700; }
