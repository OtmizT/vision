...
.label { font-family: var(--font-body); font-size: var(--fs-xs); color: var(--text-dim); }
.value { font-size: var(--fs-sm); color: var(--text); }
.td-mono { font-family: var(--font-body); font-size: var(--fs-xs); }
...
.section-title {
  font-family: var(--font-body); font-size: var(--fs-xs); letter-spacing: 1.5px;
