...
.logo-sub { font-family: var(--font-body); font-size: var(--fs-xs); color: var(--text-dim); letter-spacing: 2px; margin-top: 1px; }
...
.nav-label {
  font-family: var(--font-body); font-size: var(--fs-xs); letter-spacing: 2px; color: var(--text-dim);
...
.user-role { font-family: var(--font-body); font-size: var(--fs-xs); color: var(--text-dim); }
