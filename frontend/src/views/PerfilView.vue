  ...
  <div style="padding:24px;max-width:560px">
    ...
    <div class="card" style="padding:24px;margin-bottom:16px">
      <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px">
        ...
        <div>
          ...
          <p style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim);margin-top:3px">{{ auth.user?.email }}</p>
      ...
      <div style="border-top:1px solid var(--border);padding-top:16px;display:flex;flex-direction:column;gap:10px">
        <div style="display:flex;justify-content:space-between;align-items:center">
          <span style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">TEMA</span>
    ...
    <div class="card" style="padding:24px;margin-bottom:16px">
      ...
      <div style="display:flex;flex-direction:column;gap:14px">
        ...
        <p v-if="pwErr" style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--danger)">{{ pwErr }}</p>
        <p v-if="pwOk" style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--success)">Senha alterada com sucesso.</p>
...
.pill{display:inline-flex;padding:2px 9px;border-radius:20px;font-family:var(--font-body);font-size: var(--fs-xs);font-weight:600;background:var(--primary-weak);color:var(--primary)}
