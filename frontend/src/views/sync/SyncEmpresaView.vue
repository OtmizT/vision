...
.bc-root { font-family: var(--font-body); font-size: var(--fs-xs); color: var(--text-dim); text-transform: uppercase; letter-spacing: 1px; }
.bc-sep { color: var(--border-strong); }
.bc-current { font-family: var(--font-body); font-size: var(--fs-sm); font-weight: 700; color: var(--primary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
