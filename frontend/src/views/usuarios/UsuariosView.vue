...
<div v-if="loading" style="padding:48px;text-align:center"><div class="spinner"></div></div>
      ...
      <div v-else-if="usuarios.length===0" style="padding:48px;text-align:center;font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">Nenhum usuario cadastrado.</div>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="u in usuarios" :key="u.id">
              ...
              <td style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">{{ u.email }}</td>
              ...
              <td style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">{{ fmt(u.created_at) }}</td>
