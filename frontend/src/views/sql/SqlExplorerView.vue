  ...
  <div style="padding:24px">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;flex-wrap:wrap;gap:12px">
      ...
      <div v-if="auth.isAdminGlobal" style="display:flex;align-items:center;gap:8px">
        <span style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">GRUPO</span>
        <select
      ...
      <div v-else style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">
        {{ grupoNome }}
      </div>
    </div>
    ...
    <div
      v-if="!activeGrupoId"
      style="padding:48px;text-align:center;font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)"
    >
        ...
        <div class="main-panel">
          ...
          <div class="editor-wrapper">
            ...
            <div class="editor-footer">
              <span style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim)">
          ...
          <div
            v-if="queryError"
            style="margin-top:12px;padding:12px 14px;background:var(--danger-weak);border:1px solid var(--danger-weak);border-radius:8px;font-family:var(--font-body);font-size: var(--fs-xs);color:var(--danger)"
          >
            {{ queryError }}
          </div>
          ...
          <div v-if="result" class="result-panel">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;flex-wrap:wrap">
              ...
              <span
                ...
                style="font-family:var(--font-body);font-size: var(--fs-xs);padding:2px 8px;border-radius:4px;background:var(--warning-weak);color:var(--warning);border:1px solid var(--warning-weak)"
              >
                Truncado em 1000 linhas
              </span>
            </div>

            <div v-if="result.columns.length === 0" style="font-family:var(--font-body);font-size: var(--fs-xs);color:var(--text-dim);padding:24px 0;text-align:center">
              Nenhum resultado.
            </div>
